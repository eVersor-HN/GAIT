...
import dev.eversorhn.momentum.simdemo.util.withFullMotion
import kotlin.random.Random

// Fixed demo content -- this app has no real Twin/Horde data to read, by design (a separate
// app can't see the main MOMENTUM app's database, and shouldn't try to). See
...
fun SimulationScreen() {
    ...
    Column(
        ...
        if (!finished) {
            ...
            Text("This is what MOMENTUM feels like", style = MaterialTheme.typography.headlineLarge)
