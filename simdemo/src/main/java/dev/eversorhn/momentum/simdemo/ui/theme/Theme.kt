package dev.eversorhn.momentum.simdemo.ui.theme
...
@Composable
fun MomentumDemoTheme(content: @Composable () -> Unit) {
    MaterialTheme(colorScheme = MomentumColorScheme, typography = MomentumTypography, shapes = MomentumShapes, content = content)
}
