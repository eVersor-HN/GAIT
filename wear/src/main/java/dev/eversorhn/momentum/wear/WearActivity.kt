...
/**
 * MOMENTUM on the wrist: the two numbers you would otherwise pull a phone out of a pocket for —
        ...
        Box(
            ...
            Column(
                ...
                if (state.opponent.isBlank()) {
                    Text("MOMENTUM", color = Brass, fontSize = 22.sp, fontWeight = FontWeight.Bold)
