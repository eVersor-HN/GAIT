package dev.eversorhn.momentum.domain.transfer
...
import dev.eversorhn.momentum.domain.roster.Archetype
 ...
 * ledger, in a form another MOMENTUM can take in. On import it becomes a roster slot in the other
...
object AssetTransfer {
    ...
    const val FORMAT = "MOMENTUM-ASSET/1"
    ...
    fun assess(
        ...
        return TransferAsset(id, displayName, kind, archetype, talent, consistency, grit, trend, trainingMinute, restMask, index.toInt(), tenure, ledger.roundsPlayed, assessment, strengths, weaknesses, todayEpochDay, "MOMENTUM")
    }
