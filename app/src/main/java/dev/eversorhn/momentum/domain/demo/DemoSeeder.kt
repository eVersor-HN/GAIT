package dev.eversorhn.momentum.domain.demo
...
import dev.eversorhn.momentum.domain.route.RouteMetrics
...
object DemoSeeder {
    ...
    suspend fun seed(repository: MomentumRepository, context: Context) {
        val rng = Random(42)
     ...
     */
    suspend fun remove(repository: MomentumRepository, context: Context): Int {
