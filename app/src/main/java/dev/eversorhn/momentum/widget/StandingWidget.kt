package dev.eversorhn.momentum.widget
...
object WidgetRenderer {
    ...
    internal suspend fun renderInternal(context: Context) {
        ...
        val app = context.applicationContext as? MomentumApplication ?: return
        ...
        if (profile == null) {
            ...
            dev.eversorhn.momentum.wear.WearPublisher.publishStanding(context, "", "—", "No enrolment")
            return
        }
        ...
        dev.eversorhn.momentum.wear.WearPublisher.publishStanding(
            context = context,
...
class WidgetRefreshWorker(context: Context, params: androidx.work.WorkerParameters) :
    ...
    companion object {
        const val UNIQUE_WORK_NAME = "momentum-widget-refresh"
