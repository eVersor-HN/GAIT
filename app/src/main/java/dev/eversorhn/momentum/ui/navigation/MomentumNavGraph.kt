package dev.eversorhn.momentum.ui.navigation
...
import dev.eversorhn.momentum.ui.briefing.BriefingScreen
import dev.eversorhn.momentum.ui.enrol.EnrolScreen
import dev.eversorhn.momentum.ui.home.HomePage
import dev.eversorhn.momentum.ui.home.HomeScreen
import dev.eversorhn.momentum.ui.logsession.LogSessionScreen
import dev.eversorhn.momentum.ui.profiles.ProfilesScreen
import dev.eversorhn.momentum.ui.restdays.RestDaysScreen
import dev.eversorhn.momentum.ui.settings.SettingsScreen
import dev.eversorhn.momentum.ui.theme.Alert
import dev.eversorhn.momentum.ui.theme.CorpoBackground
import dev.eversorhn.momentum.ui.theme.CorpoStatusBar
import dev.eversorhn.momentum.ui.theme.Cyan
import dev.eversorhn.momentum.ui.theme.LedgerStrip
import dev.eversorhn.momentum.ui.theme.TickerItem
import dev.eversorhn.momentum.ui.theme.TickerStrip
import dev.eversorhn.momentum.ui.track.TrackScreen
...
@Composable
fun MomentumNavGraph(startSession: Boolean = false) {
    ...
    var disclaimerAccepted by androidx.compose.runtime.saveable.rememberSaveable {
        androidx.compose.runtime.mutableStateOf(
            dev.eversorhn.momentum.ui.onboarding.DisclaimerPrefs.isAccepted(gateContext)
        )
    }
    if (!disclaimerAccepted) {
        CorpoBackground {
            Column(modifier = Modifier.fillMaxSize()) {
                ...
                dev.eversorhn.momentum.ui.onboarding.DisclaimerGate(onAccepted = { disclaimerAccepted = true })
            }
        }
        return
    }
    ...
    val label = when {
        ...
        else -> routeLabels[route] ?: "MOMENTUM"
    }
