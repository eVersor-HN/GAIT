package dev.eversorhn.momentum.ui.briefing
...
fun BriefingScreen(onDone: () -> Unit) {
    Column(
        ...
        dev.eversorhn.momentum.ui.theme.CollapsiblePanel(
            ...
            summary = "What MOMENTUM is not, and what it does with what you record",
        ) {
            Text(
                "MOMENTUM is not a medical device and gives no medical or training advice. Its targets " +
        ...
        FootNote("MOMENTUM · Asset Performance Division")
