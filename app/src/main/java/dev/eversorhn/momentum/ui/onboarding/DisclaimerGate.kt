package dev.eversorhn.momentum.ui.onboarding
...
/**
 * The first thing the app shows, once. What MOMENTUM is, what it is not, and what it cannot do for
...
fun DisclaimerGate(onAccepted: () -> Unit) {
    ...
    Column(
        ...
        CorpoPanel(tone = PanelTone.WARN) {
            ...
            Text(
                "MOMENTUM is built to make you push. It shows you a pace to hold, a gap to close and a " +
        ...
        CorpoPanel {
            ...
            Text(
                "MOMENTUM is not a medical device and gives no medical, diagnostic or training advice. " +
        ...
        CorpoPanel {
            ...
            Text(
                "MOMENTUM is free software provided as is, without warranty of any kind. Distances, " +
...
object DisclaimerPrefs {
    private const val PREFS = "momentum_disclaimer"
