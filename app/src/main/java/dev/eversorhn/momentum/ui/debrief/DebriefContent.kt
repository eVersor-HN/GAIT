package dev.eversorhn.momentum.ui.debrief
...
import dev.eversorhn.momentum.ui.theme.CompareGrid
import dev.eversorhn.momentum.ui.theme.CompareRow
...
import dev.eversorhn.momentum.ui.theme.formatSignedPoints
    ...
    Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
        ...
        result.roundWinner?.let { winner ->
            ...
            CorpoPanel(tone = if (toUser) PanelTone.GOOD else PanelTone.WARN) {
                ...
                Text(
                    dev.eversorhn.momentum.domain.ledger.Ledger.rulingLabel(toUser, result.stake, result.opponentName, isHorde),
                ...
                FootNote(
                    dev.eversorhn.momentum.domain.ledger.Ledger.standingLabel(result.ledger, result.opponentName, isHorde) +
