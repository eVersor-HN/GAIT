...
import dev.eversorhn.momentum.ui.theme.CollapsiblePanel
import dev.eversorhn.momentum.ui.theme.Cyan
import dev.eversorhn.momentum.ui.theme.FootNote
import dev.eversorhn.momentum.ui.theme.FormDots
import dev.eversorhn.momentum.ui.theme.MessageCard
import dev.eversorhn.momentum.ui.theme.MessageTone
import dev.eversorhn.momentum.ui.theme.Meter
import dev.eversorhn.momentum.ui.theme.StageBar
import dev.eversorhn.momentum.ui.theme.PanelTone
import dev.eversorhn.momentum.ui.theme.PhaseTrack
import dev.eversorhn.momentum.ui.theme.Quote
...
fun ForecastScreen(
    ...
    val viewModel: ForecastViewModel = dev.eversorhn.momentum.ui.momentumViewModel()
                ...
                CorpoPanel {
                    Row(modifier = Modifier.fillMaxWidth(), verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Text(
                            ...
                            else "${s.calibration.sessions} / ${dev.eversorhn.momentum.ui.forecast.Calibration.FULL_AT}",
                    ...
                    StageBar(
                        ...
                        stages = listOf(
                            "Estimates" to dev.eversorhn.momentum.ui.forecast.Calibration.FORECAST_AT / dev.eversorhn.momentum.ui.forecast.Calibration.FULL_AT.toFloat(),
                            "Points" to dev.eversorhn.momentum.ui.forecast.Calibration.STAKES_AT / dev.eversorhn.momentum.ui.forecast.Calibration.FULL_AT.toFloat(),
                            "Full" to 1f,
                        ),
