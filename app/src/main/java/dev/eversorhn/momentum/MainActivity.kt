...
import dev.eversorhn.momentum.ui.navigation.MomentumNavGraph
import dev.eversorhn.momentum.ui.theme.MomentumTheme

class MainActivity : ComponentActivity() {

    companion object {
        /** Set by the quick-settings tile: open straight on the session screen. */
        const val EXTRA_START_SESSION = "momentum.start_session"
    }
        ...
        setContent {
            MomentumTheme {
                Surface(
                    ...
                    MomentumNavGraph(startSession = intent?.getBooleanExtra(EXTRA_START_SESSION, false) == true)
                }
            }
        }
    }
