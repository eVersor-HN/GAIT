 ...
 * ones MOMENTUM doesn't have yet, tagged [SessionSource.HEALTH]. Read-only; MOMENTUM writes nothing
...
object HealthImport {
    ...
    /** Exercise types that map onto a MOMENTUM activity key. */
     ...
     */
    suspend fun importRecent(context: Context, repository: MomentumRepository): Result {
        return try {
