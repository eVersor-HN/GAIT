 ...
 *
 * The same console dialog as everywhere else — no stock system dialog anywhere in GAIT.
 */
@Composable
fun ExitGuard(opponentName: String) {
    ...
    CorpoDialog(
        ...
        body = "$opponentName keeps training either way. Choose whether it can still reach you while GAIT is closed.",
