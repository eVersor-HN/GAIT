...
import dev.eversorhn.gait.domain.opponent.OpponentSession
...
class OpponentSessionWorker(context: Context, params: WorkerParameters) : CoroutineWorker(context, params) {
    ...
    companion object {
        const val UNIQUE_WORK_NAME = "gait-opponent-session"
        const val FOLLOW_UP_WORK_NAME = "gait-opponent-session-follow-up"
