...
/**
 * Writing a finished session back to Health Connect, so what you record in GAIT counts
...
object HealthExport {
    ...
    /** The Health Connect exercise type for a GAIT activity, or null when there is no sensible one. */
...
object ExportPrefs {
    private const val PREFS = "gait_health_export"
