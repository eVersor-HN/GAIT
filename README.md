...
docs/voice-design.md                  — the single GAIT voice: character, delivery, processing
docs/privacy-policy.md                — what GAIT stores (everything local) and what leaves the device (nothing)
